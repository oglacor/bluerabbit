<div class="layer base relative">
	...
	<?php if($challenge->quest_success_message){ ?>
		<div class="success-message text-center white-color padding-10 max-w-900 boxed relative">
		...
		<?php if($achievement_reward){ ?>
			<div class="text-center relative padding-10 inline-block w-250">
				...
				<div class="icon-group inline-table layer relative base">
					<button class="br-icon-btn br-icon-btn-purple">
	...
	<div class="padding-10 w-full text-center">
		...
		$nextMilestone = (isset($playerState) && isset($adv_parent_id))
			? BR_Progression::instance()->getNextAvailableMilestone($adv_parent_id, $adv_child_id, $challenge->quest_id, $adventure, $playerState)
			: null;
		if ($nextMilestone): ?>
