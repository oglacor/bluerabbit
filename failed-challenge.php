<div class="layer base relative">
	...
	<h1 class="font _40 w900 uppercase padding-10"><?= __("Challenge Failed!","bluerabbit"); ?></h1>
	
	<div class="padding-10 w-full text-center">
		<a href="<?=get_bloginfo('url')."/challenge/?questID=$challenge->quest_id&adventure_id=$adv_child_id";?>" class="form-ui white-bg padding-5 margin-5 red-A400 font _24 w900 uppercase opacity-50">
