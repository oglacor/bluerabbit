...
$show_public_adventures = ($roles[0] == 'administrator' && $config['adventure_privacy']['value']) ? " OR (adventures.adventure_privacy = 'public' AND adventures.adventure_status = 'publish') " : "";
