<div class="card" id="keyword-card-<?= $c->objective_id; ?>">
	...
	<div class="layer base relative text-center">
		...
		<div class="input-group inline-table">
			<button class="button-icon font _24 sq-40  blue-grey-bg-900 teal-A400 icon-lg border border-all border-2 teal-border-500" onClick="$('#keyword-input-<?= $c->objective_id; ?>').val('True'); factCheck(<?= $c->objective_id; ?>);">
				<span class="icon icon-like"></span>
			</button>
			<button class="button-icon font _24 sq-40  blue-grey-bg-900 teal-A400 icon-lg border border-all border-2 teal-border-500"  onClick="$('#keyword-input-<?= $c->objective_id; ?>').val('False'); factCheck(<?= $c->objective_id; ?>);">
