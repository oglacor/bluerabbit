		...
		<?php }elseif($q['survey_question_type']=='rating'){ ?>
			...
			<div class="highlight padding-10 grey-bg-100 text-center">
				<span class="rating">
					...
					<button class="button-icon font _24 sq-40  star-1 <?php echo $q['survey_answer_value'] >= 1 ? 'amber-bg-400' : ''; ?>" onClick="updateQuestionValue('<?php echo $key; ?>',1);">
						<span class="icon icon-star"></span>
						<span class="tool-tip top">
							<span class="tool-tip-text"><?php _e("1 STAR"); ?></span>
						</span>
					</button>
					<button class="button-icon font _24 sq-40  star-2 <?php echo $q['survey_answer_value'] >= 2 ? 'amber-bg-400' : ''; ?>" onClick="updateQuestionValue('<?php echo $key; ?>',2);">
						<span class="icon icon-star"></span>
						<span class="tool-tip top">
							<span class="tool-tip-text"><?php _e("2 STARS"); ?></span>
						</span>
					</button>
					<button class="button-icon font _24 sq-40  star-3 <?php echo $q['survey_answer_value'] >= 3 ? 'amber-bg-400' : ''; ?>" onClick="updateQuestionValue('<?php echo $key; ?>',3);">
						<span class="icon icon-star"></span>
						<span class="tool-tip top">
							<span class="tool-tip-text"><?php _e("3 STARS"); ?></span>
						</span>
					</button>
					<button class="button-icon font _24 sq-40  star-4 <?php echo $q['survey_answer_value'] >= 4 ? 'amber-bg-400' : ''; ?>" onClick="updateQuestionValue('<?php echo $key; ?>',4);">
						<span class="icon icon-star"></span>
						<span class="tool-tip top">
							<span class="tool-tip-text"><?php _e("4 STARS"); ?></span>
						</span>
					</button>
					<button class="button-icon font _24 sq-40  star-5 <?php echo $q['survey_answer_value'] >= 5 ? 'amber-bg-400' : ''; ?>" onClick="updateQuestionValue('<?php echo $key; ?>',5);">
						<span class="icon icon-star"></span>
						<span class="tool-tip top">
