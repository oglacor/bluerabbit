...
<li class="card<?= $can_view_roster ? ' guild-lb-clickable' : ''; ?><?= $is_my_guild_row ? ' is-my-guild' : ''; ?>" id="guild-lb-<?= $lg->guild_id; ?>" <?= $can_view_roster ? 'onclick="openGuildRoster(' . $lg->guild_id . ');"' : ''; ?>>
    ...
    <div class="guild-lb-badge">
        <img src="<?= esc_url($lg->guild_logo); ?>" class="badge">
    </div>
    <div class="guild-lb-info">
        <div class="guild-lb-name"><?= esc_html($lg->guild_name); ?></div>
        <div class="guild-lb-stats">
            ...
            <span class="guild-lb-stat">
                ...
                <span class="stat-value yellow">$<?= number_format((int) $lg->total_player_bloo); ?></span>
            </span>
        </div>
    </div>
