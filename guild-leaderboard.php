<li class="card" id="guild-lb-<?php echo $lg->guild_id; ?>">
	<img src="<?= $lg->guild_logo; ?>" class="badge border rounded-max">
	...
	<div class="highlight text-center font _24 w300 white-color">
		<span class="button-form-ui <?= $lg->guild_color; ?>-bg-400 font _20">
			<?= $lg->guild_name; ?>
		</span><br>
		<span class="button-form-ui amber-bg-200 font _14 blue-grey-700 w900 kerning-1" id="guild-lb-xp-<?php echo $lg->guild_id; ?>">
