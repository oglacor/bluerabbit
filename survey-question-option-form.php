...
<li class="option form" id="option-<?php echo $oKey; ?>">
	...
	<div class="option-image-buttons">
		<button class="button-icon font _24 sq-40  green-bg-500 white-color" onClick="showWPUpload(<?php echo $params; ?>);">
			<span class="icon icon-image"></span>
		</button>
		<button class="button-icon font _24 sq-40  red-bg-400 white-color" onClick="clearImage('#option-image-<?php echo $oKey; ?>');updateOption('survey',<?php echo "$qKey, $oKey"; ?>);">
	...
	<div class="option-actions">
		...
		<div class="confirm-action overlay-layer" id="confirm-option-<?php echo $oKey; ?>">
			...
			<div class="confirm-buttons-container">
				<button class="button-icon green-bg-400 font _20 sq-30" onClick="removeOption(<?php echo $oKey; ?>,'survey');">
					<span class="icon icon-check white-color"></span>
				</button>
				<button class="button-icon font _20 sq-30 red-bg-400 white-color" onClick="hideAllOverlay();">
