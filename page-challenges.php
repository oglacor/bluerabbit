	...
	<div class="body-ui w-full">
		<div class="highlight red-bg-800 padding-10 page-break text-center">
			<div class="icon-group">
				<span class="button-icon font _24 sq-40  red-bg-400 icon-lg">
			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						...
						<td><a class="button-icon font _24 sq-40  indigo-bg-400" target="_blank" href="<?= get_bloginfo('url')."/challenges-report/?questID={$q->quest_id}"; ?>"><span class="icon icon-view"></span></a></td>
					</tr>
					<?php } ?>
				</tbody>
			</table>
